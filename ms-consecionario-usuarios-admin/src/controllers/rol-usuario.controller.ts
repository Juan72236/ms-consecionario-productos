...
export class RolUsuarioController {
  ...
  async create(
    ...
    return this.rolRepository.rolEstaAsociadoAmuchosUsuarios(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.rolRepository.rolEstaAsociadoAmuchosUsuarios(id).patch(usuario, where);
  }
