...
export class VendedorUsuarioVendedorController {
  ...
  async get(
    ...
    return this.vendedorRepository.vendedorTieneUnUsuario(id).get(filter);
  }
  ...
  async create(
    ...
    return this.vendedorRepository.vendedorTieneUnUsuario(id).create(usuarioVendedor);
  }
  ...
  async patch(
    ...
    return this.vendedorRepository.vendedorTieneUnUsuario(id).patch(usuarioVendedor, where);
  }
  ...
  async delete(
    ...
    return this.vendedorRepository.vendedorTieneUnUsuario(id).delete(where);
  }
}
