...
export class VehiculoFotoController {
  ...
  async find(
    ...
    return this.vehiculoRepository.vehiculoTieneMuchasFotos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculoRepository.vehiculoTieneMuchasFotos(id).create(foto);
  }
  ...
  async patch(
    ...
    return this.vehiculoRepository.vehiculoTieneMuchasFotos(id).patch(foto, where);
  }
  ...
  async delete(
    ...
    return this.vehiculoRepository.vehiculoTieneMuchasFotos(id).delete(where);
  }
}
